window.addEventListener('DOMContentLoaded', () => {
  ...
  const boton = document.getElementById('boton-rotar') as HTMLElement;
  const esfera = document.getElementById('esfera') as HTMLObjectElement;
  const disco0 = document.getElementById('disco0') as HTMLObjectElement;
  ...
  const perdidaMax = document.getElementById('perdida-max') as HTMLDivElement;
  const retorno = document.getElementById('retorno') as HTMLDivElement;
  const perdidaMaxDiv = document.getElementById('perdida-max') as HTMLElement;
  const retornoDiv = document.getElementById('retorno') as HTMLElement;
  const porcentajeRealDiv = document.getElementById('porcentajeReal');


  // Objetos varios
  const objeto1 = document.getElementById('objeto1') as HTMLObjectElement;
  const objeto2 = document.getElementById('objeto2') as HTMLObjectElement;
  const objeto3 = document.getElementById('objeto3') as HTMLObjectElement;
  const objeto4 = document.getElementById('objeto4') as HTMLObjectElement;
  const objeto5 = document.getElementById('objeto5') as HTMLObjectElement;
  const objeto6 = document.getElementById('objeto6') as HTMLObjectElement;

  const objeto7 = document.getElementById('objeto7') as HTMLObjectElement;
  const objeto8 = document.getElementById('objeto8') as HTMLObjectElement; // oculto
  const objeto9 = document.getElementById('objeto9') as HTMLObjectElement;
  const objeto10 = document.getElementById('objeto10') as HTMLObjectElement;
  const objeto11 = document.getElementById('objeto11') as HTMLObjectElement;
  const objeto12 = document.getElementById('objeto12') as HTMLObjectElement;
  const objeto13 = document.getElementById('objeto13') as HTMLObjectElement;
  const objeto14 = document.getElementById('objeto14') as HTMLObjectElement;
  const objeto15 = document.getElementById('objeto15') as HTMLObjectElement;
  const objeto16 = document.getElementById('objeto16') as HTMLObjectElement;
  const objeto17 = document.getElementById('objeto17') as HTMLObjectElement;
  const objeto18 = document.getElementById('objeto18') as HTMLObjectElement;
  const objeto19 = document.getElementById('objeto19') as HTMLObjectElement;
  const cuadroInversion = document.getElementById('cuadro-inversion');


  // Manecillas
  const manecillaHora = document.getElementById('manecillaHora') as HTMLElement;
  manecillaHora.style.filter = 'drop-shadow(2px 2px 3px rgba(132, 126, 126, 2.35))';
  const manecillaMinuto = document.getElementById('manecillaMinuto') as HTMLElement;
  manecillaMinuto.style.filter = 'drop-shadow(2px 2px 3px rgba(132, 126, 126, 2.35))';
  const manecillaSegundo = document.getElementById('manecillaSegundo') as HTMLElement;
  ...
  const manecillaAlma = document.getElementById('manecillaAlma') as HTMLElement;
  ...
  const discominicentro = document.getElementById('discominicentro') as HTMLElement;
  const puntero = document.getElementById('puntero') as HTMLElement;
  const mascaraprueba = document.getElementById('mascaraprueba') as HTMLElement;
  mascaraprueba.style.filter = 'drop-shadow(0 1px 2px rgba(132, 126, 126, .8))';;

  const posAbsolutePuntero = document.getElementById('posAbsolutePuntero') as HTMLElement;
  const posAbsoluteDiscoMiniCentro = document.getElementById('posAbsoluteDiscoMiniCentro') as HTMLElement;
  const cristal = document.getElementById('cristal') as HTMLElement;

  // Contenedor principal para cálculos de centro
  const container = boton.parentElement as HTMLElement;

  // Botones laterales
  const btn1 = document.querySelector('#side-buttons button:nth-child(1)') as HTMLButtonElement;
  const btn2 = document.querySelector('#side-buttons button:nth-child(2)') as HTMLButtonElement;
  const btn3 = document.querySelector('#side-buttons button:nth-child(3)') as HTMLButtonElement;
  const btn4 = document.querySelector('#side-buttons button:nth-child(4)') as HTMLButtonElement;
  const btn5 = document.querySelector('#side-buttons button:nth-child(5)') as HTMLButtonElement;
  const btn6 = document.querySelector('#side-buttons button:nth-child(6)') as HTMLButtonElement;
  ...
  const boton1Externo = document.getElementById('boton1') as HTMLElement | null;
...
window.addEventListener("load", () => {
  const elementosReloj: HTMLElement[] = [
...
function getFondoActual(): string {
...
objeto4.addEventListener('load', () => {
  ...
  function posicionarElemento(elem: HTMLElement, fixedX: number, fixedY: number, offsetX: number, offsetY: number) {
...
fixedPositions.numeros.forEach(({ elem, x, y }) => {
  ...
  posicionarElemento(boton,
    fixedPositions.boton.x,
    fixedPositions.boton.y,
    fixedPositions.boton.x - centerX,
    fixedPositions.boton.y - centerY);

  posicionarElemento(disco0,
    fixedPositions.disco0.x,
    fixedPositions.disco0.y,
    fixedPositions.disco0.x - centerX,
    fixedPositions.disco0.y - centerY);
  ...
  fondosObjetos.forEach(obj => {
    posicionarElemento(obj,
      fixedPositions.objetos[6].x,
      fixedPositions.objetos[6].y,
      fixedPositions.objetos[6].x - centerX,
      fixedPositions.objetos[6].y - centerY);
    obj.style.opacity = '0';
  ...
  const coloresSombraPorFondo: Record<string, string> = {
  "Fund I": "#00aaff",
  "Fund II": "#ffb07b",
  "Fund III": "#7fe5ac",
  "Fund IV": "#0fc0ea",
  ...
  function actualizarOpacidadFondos(nuevoIndex: number) {
    if (nuevoIndex === currentFundIndex) return;

    const totalFondos = fondosObjetos.length;
    if (nuevoIndex < 0) nuevoIndex = totalFondos - 1;
    else if (nuevoIndex >= totalFondos) nuevoIndex = 0;
  ...
  function getRotatableDias() {
    return objeto1.contentDocument?.getElementById('rotatableDias') as SVGGElement | null;
  }
  function getRotatableDias2() {
    return objeto2.contentDocument?.getElementById('rotatableDias2') as SVGGElement | null;
  }
  function getRotatableMeses() {
    return objeto3.contentDocument?.getElementById('rotatableMeses') as SVGGElement | null;
  }
  function getRotatableRomanos() {
    return objeto4.contentDocument?.getElementById('rotatableRomanos') as SVGGElement | null;
  }
  function getRotatableObjeto5() {
    return objeto5.contentDocument?.getElementById('rotatableObjeto5') as SVGGElement | null;
  }
  ...
  function actualizarTransformEsfera() {
    ...
    const rotatable = esfera.contentDocument?.getElementById('rotatable');
    if (rotatable) {
  ...
  function actualizarCuadroInversion(fondo: any) {
  const resumen = document.getElementById('resumen') as HTMLInputElement;
  const gestionadoPor = document.getElementById('gestionadoPor') as HTMLInputElement;
  const expReturn = document.getElementById('expReturn') as HTMLInputElement;
  const maxLoss = document.getElementById('maxLoss') as HTMLInputElement;
  const fechaDesde = document.getElementById('fechaDesde') as HTMLInputElement;
  const fechaHasta = document.getElementById('fechaHasta') as HTMLInputElement;
  const estadoSubscripcion = document.getElementById('estadoSubscripcion') as HTMLInputElement;
  const desdeSubscripcion = document.getElementById('desdeSubscripcion') as HTMLInputElement;
  const hastaSubscripcion = document.getElementById('hastaSubscripcion') as HTMLInputElement;
  const fundID = document.getElementById('fundID') as HTMLInputElement;
  const blank1 = document.getElementById('blank1') as HTMLInputElement;
...
function rotarDiscoPeriodo(descripcionPeriodo: string) {
  const periodoToIndexMap: Record<string, number> = {
    "1 year": 0,
    "2 years": 1,
    "3 years": 2,
    "4 years": 3,
  ...
  const index = periodoToIndexMap[descripcionPeriodo] ?? 0; // default 0 si no encuentra
...
function actualizarColorSombra(color: string) {
  if (cuadroInversion) {
...
function calcularRotacionDia(dia: number) {
...
function actualizarRotacionObjeto4() {
  ...
  let anguloObjeto5 = 0;
  let animacionIdObjeto5: number | null = null;

  function animarRotacionContinuaObjeto5() {
    if (!animacionActivaObjeto5) return;
...
function actualizarAngulosAlmaDesdeFondo(fondo: any) {
  ...
  const retornoStr = retornoDiv?.textContent || fondo.retorno || "";
  const perdidaStr = perdidaMaxDiv?.textContent || fondo.perdidaMax || "";
  ...
  function calcularPorcentajeNormalizado(anguloActualAlma: number): number {
...
function calcularValorRealPorcentaje(angulo: number): number {
  ...
  // Botón principal de rotación y cambio de fondo
    ...
    if (nuevoIndex >= fondosObjetos.length) nuevoIndex = 0;
...
(window as any).actualizarCuadroInversion = actualizarCuadroInversion;
(window as any).rotarDiscoPeriodo = rotarDiscoPeriodo;
(window as any).actualizarAngulosAlmaDesdeFondo = actualizarAngulosAlmaDesdeFondo;
...
fetch("/backend/fondos.json")
  ...
  .then(data => {
    ...
    const fondo = data.find((f: any) => f.nombre === fondoInicial);
    if (fondo) {
...
window.addEventListener("fondoCambiado", (e: any) => {
  ...
  fetch("/backend/fondos.json")
    .then(res => res.json())
    .then(data => {
      const fondo = data.find((f: any) => f.nombre === fondoNombre);
      if (fondo) {
        actualizarCuadroInversion(fondo);
        actualizarAngulosAlmaDesdeFondo(fondo);
        rotarDiscoPeriodo(fondo.descripcionPeriodo || "3 years");
...
// Función para forzar la opacidad de los objetos según el fondo seleccionado
function forzarOpacidades(nuevoIndex: number) {
...
btn6.addEventListener('click', () => {
  ...
  const offsetXEsferaSlider = document.getElementById('offsetXEsfera') as HTMLInputElement;
  const offsetYEsferaSlider = document.getElementById('offsetYEsfera') as HTMLInputElement;
  const offsetXValueEsfera = document.getElementById('offsetXValueEsfera') as HTMLElement;
  const offsetYValueEsfera = document.getElementById('offsetYValueEsfera') as HTMLElement;
  const posAbsoluteEsfera = document.getElementById('posAbsoluteEsfera') as HTMLElement;
  ...
  const offsetXDiscoSlider = document.getElementById('offsetXDiscoMiniCentro') as HTMLInputElement;
  const offsetYDiscoSlider = document.getElementById('offsetYDiscoMiniCentro') as HTMLInputElement;
  const offsetXPunteroSlider = document.getElementById('offsetXPuntero') as HTMLInputElement;
  const offsetYPunteroSlider = document.getElementById('offsetYPuntero') as HTMLInputElement;

  function actualizarPosicion(elem: HTMLElement, offsetX: number, offsetY: number) {
    elem.style.position = 'absolute';
    elem.style.left = `calc(50% + ${offsetX}px)`;
    elem.style.top = `calc(50% + ${offsetY}px)`;
    elem.style.transform = 'translate(-50%, -50%)';
  ...
  // Helper para crear controles de offset para cada manecilla
  interface ControlManecilla {
    offsetXSlider: HTMLInputElement;
    offsetYSlider: HTMLInputElement;
    offsetXValue: HTMLElement;
    offsetYValue: HTMLElement;
    posAbsolute: HTMLElement;
    elem: HTMLElement;
    fixedX: number;
    fixedY: number;
  }

  function crearControlesManecilla(
    idPrefix: string,
    elem: HTMLElement,
    fixedX: number,
    fixedY: number
    ...
    return {
      offsetXSlider: document.getElementById(`offsetX${idPrefix}`) as HTMLInputElement,
      offsetYSlider: document.getElementById(`offsetY${idPrefix}`) as HTMLInputElement,
      offsetXValue: document.getElementById(`offsetXValue${idPrefix}`) as HTMLElement,
      offsetYValue: document.getElementById(`offsetYValue${idPrefix}`) as HTMLElement,
      posAbsolute: document.getElementById(`posAbsolute${idPrefix}`) as HTMLElement,
      elem,
      fixedX,
      fixedY,
    };
  ...
  function actualizarPosicionManecilla(ctrl: ControlManecilla) {
  ...
  function agregarListenersManecilla(ctrl: ControlManecilla) {
...
function actualizarFecha() {
  ...
  const offsetDias = 1.425 + offsetXDia;  // Puedes ir cambiando 0 a 6
  ...
  const diaMesIndex = (diaMes - offsetDias + totalDiasMes) % totalDiasMes;8
...
requestAnimationFrame(centrarDia);
  ...
  if (rotDias2) actualizarRotacionObjeto2();
  if (rotMeses) actualizarRotacionObjeto3();
  actualizarRotacionObjeto4();
  ...
  posicionarElemento(cristal, fixedPositions.cristal.x, fixedPositions.cristal.y,
                     fixedPositions.cristal.x - centerX, fixedPositions.cristal.y - centerY);
...
inicializarRotaciones();
  ...
  function actualizarPosicionYCoordenadas(
  elem: HTMLElement,
  offsetX: number,
  offsetY: number,
  fixedX: number,
  fixedY: number,
  posAbsoluteElem: HTMLElement
) {
